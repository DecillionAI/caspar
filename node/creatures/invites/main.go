...
func process(input string) string {
	...
	hostReq("microPutJson", map[string]any{"key": "Json::CreatureNamespace::invites", "path": "lastInput", "data": p.Payload, "merge": true})
	if p.Path != "" {
		hostReq("microPutLink", map[string]any{"key": "creatureNamespace::invites::lastPath", "value": p.Path})
	}
