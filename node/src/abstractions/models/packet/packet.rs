//! Translation of `abstract/models/packet/packet.go`.
...
mod tests {
    use super::*;
    use crate::abstractions::models::packet::command::Command;
    use crate::abstractions::models::packet::error::build_error_json;

    // Translation of packet_test.go::TestBuildErrorJson.
    #[test]
    ...
    // Translation of packet_test.go::TestPacketJsonShapes.
    #[test]
