...
pub struct TrxWrapper {
    _core: Arc<dyn ICore>,
    db: crate::abstractions::adapters::storage::KvDb,
    readonly: bool,
    inner: Mutex<Inner>,
}
...
mod tests {
    ...
    impl ICore for StubCore {
        ...
        fn modify_state(
            &self,
            _: bool,
            mut fn_: crate::abstractions::models::action::action::TrxClosure,
        ) {
    ...
    struct StubStorage {
        root: String,
        kv: crate::abstractions::adapters::storage::KvDb,
        ts: crate::abstractions::adapters::storage::TsDb,
    }
    ...
    impl StubStorage {
        fn new() -> Arc<Self> {
            ...
            let kv: crate::abstractions::adapters::storage::KvDb = Arc::new(
    ...
    impl IStorage for StubStorage {
        ...
        fn kv_db(&self) -> crate::abstractions::adapters::storage::KvDb { self.kv.clone() }
        fn ts_db(&self) -> crate::abstractions::adapters::storage::TsDb { self.ts.clone() }
