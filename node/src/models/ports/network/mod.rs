...
/// Raw PEM-encoded TLS material plus the relevant verification flags.
///
/// A single value is used for both listening and dialing; the network
/// driver builds the appropriate `rustls` server/client configuration on
/// demand.
