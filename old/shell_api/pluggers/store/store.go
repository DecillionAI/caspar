...
import (
	...
	actions "kasper/src/shell/api/actions/store"
...
func (c *Plugger) ListStoreMachines() iaction.IAction {
	return utils.ExtractSecureAction(c.Core, c.Actions.ListStoreMachines)
}
