...
func process(input string) string {
	...
	if "listStoreInvites" == "create" || "listStoreInvites" == "createFromStore" || "listStoreInvites" == "createShard" {
		hostReq("genId", map[string]any{"source": "invites.listStoreInvites"})
	}
	...
	if p.UserID != "" {
		hostReq("dbOp", map[string]any{"op": "put", "key": "creatureEndpoint::invites::listStoreInvites::lastUser", "val": p.UserID})
	}
	if p.StoreID != "" {
