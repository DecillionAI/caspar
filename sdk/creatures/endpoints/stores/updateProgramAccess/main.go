...
func process(input string) string {
	...
	if "updateProgramAccess" == "create" || "updateProgramAccess" == "createFromSpace" || "updateProgramAccess" == "createShard" {
		hostReq("genId", map[string]any{"source": "spaces.updateProgramAccess"})
	}
	...
	if p.UserID != "" {
		hostReq("dbOp", map[string]any{"op": "put", "key": "creatureEndpoint::spaces::updateProgramAccess::lastUser", "val": p.UserID})
	}
	if p.SpaceID != "" {
